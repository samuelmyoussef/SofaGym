...
if __name__ == '__main__':
    ...
    parser.add_argument("-e", "--env", help="Name of the environment",
                        type=str, required=False, default='catheter_beam_1_instrument-v0')
    ...
    #print("SAVED", root.InstrumentCombined.DOFs.position.value[-1])
    #obs = env.reset()
    ...
    #env.render()
    #print("LOADED", root.InstrumentCombined.DOFs.position.value[-1])
