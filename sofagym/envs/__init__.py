...
from sofagym.envs.CatheterBeam1Instrument.CatheterBeam1InstrumentEnv import *
...
register(
    id='catheter_beam_1_instrument-v0',
    entry_point='sofagym.envs:CatheterBeam1InstrumentEnv',
)
